...
Author: Dennis Jiang 蒋睿伦
Date: 2024-10-10
Description: This project uses a ds3231 to measure time and displays the time to an 1306 oled display,
Further, it measures temprature with a analog temprature module and displays a mapped value to a 9g-servo-motor and a RGB ring that changes bassed on the tenperture.
*/
